...
class MensagensTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Mensagem', 'IdChamado', 'NoUsuario', 'Data', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'mensagem', 'idChamado', 'noUsuario', 'data', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(MensagensTableMap::COL_ID, MensagensTableMap::COL_MENSAGEM, MensagensTableMap::COL_ID_CHAMADO, MensagensTableMap::COL_NO_USUARIO, MensagensTableMap::COL_DATA, MensagensTableMap::COL_CREATED_AT, MensagensTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'mensagem', 'id_chamado', 'no_usuario', 'data', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Mensagem' => 1, 'IdChamado' => 2, 'NoUsuario' => 3, 'Data' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'mensagem' => 1, 'idChamado' => 2, 'noUsuario' => 3, 'data' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(MensagensTableMap::COL_ID => 0, MensagensTableMap::COL_MENSAGEM => 1, MensagensTableMap::COL_ID_CHAMADO => 2, MensagensTableMap::COL_NO_USUARIO => 3, MensagensTableMap::COL_DATA => 4, MensagensTableMap::COL_CREATED_AT => 5, MensagensTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'mensagem' => 1, 'id_chamado' => 2, 'no_usuario' => 3, 'data' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
