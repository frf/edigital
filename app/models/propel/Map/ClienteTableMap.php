...
class ClienteTableMap extends TableMap
{
    ...
    {
        $this->addRelation('Categorias', '\\Categorias', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id_cliente',
    1 => ':id',
  ),
), null, null, 'Categoriass', false);
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Idoc', '\\Idoc', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idcliente',
    1 => ':id',
  ),
), 'CASCADE', 'CASCADE', 'Idocs', false);
