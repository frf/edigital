...
class UsuariosTableMap extends TableMap
{
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Chamados', '\\Chamados', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idusuario',
    1 => ':id',
  ),
), null, null, 'Chamadoss', false);
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Mensagens', '\\Mensagens', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idusuario',
    1 => ':id',
