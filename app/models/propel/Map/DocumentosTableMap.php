...
class DocumentosTableMap extends TableMap
{
    ...
    /**
     * the column name for the id_categorias field
     */
    const COL_ID_CATEGORIAS = 'documentos.id_categorias';

    /**
     * the column name for the endereco field
     */
    const COL_ENDERECO = 'documentos.endereco';
     ...
     */
    const COL_ID_CLIENTE = 'documentos.id_cliente';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'IdCategorias', 'Endereco', 'Datainclusao', 'IdCliente', 'Nomedocumento', 'Descricao', ),
        self::TYPE_CAMELNAME     => array('id', 'idCategorias', 'endereco', 'datainclusao', 'idCliente', 'nomedocumento', 'descricao', ),
        self::TYPE_COLNAME       => array(DocumentosTableMap::COL_ID, DocumentosTableMap::COL_ID_CATEGORIAS, DocumentosTableMap::COL_ENDERECO, DocumentosTableMap::COL_DATAINCLUSAO, DocumentosTableMap::COL_ID_CLIENTE, DocumentosTableMap::COL_NOMEDOCUMENTO, DocumentosTableMap::COL_DESCRICAO, ),
        self::TYPE_FIELDNAME     => array('id', 'id_categorias', 'endereco', 'datainclusao', 'id_cliente', 'nomedocumento', 'descricao', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'IdCategorias' => 1, 'Endereco' => 2, 'Datainclusao' => 3, 'IdCliente' => 4, 'Nomedocumento' => 5, 'Descricao' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'idCategorias' => 1, 'endereco' => 2, 'datainclusao' => 3, 'idCliente' => 4, 'nomedocumento' => 5, 'descricao' => 6, ),
        self::TYPE_COLNAME       => array(DocumentosTableMap::COL_ID => 0, DocumentosTableMap::COL_ID_CATEGORIAS => 1, DocumentosTableMap::COL_ENDERECO => 2, DocumentosTableMap::COL_DATAINCLUSAO => 3, DocumentosTableMap::COL_ID_CLIENTE => 4, DocumentosTableMap::COL_NOMEDOCUMENTO => 5, DocumentosTableMap::COL_DESCRICAO => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'id_categorias' => 1, 'endereco' => 2, 'datainclusao' => 3, 'id_cliente' => 4, 'nomedocumento' => 5, 'descricao' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('id_categorias', 'IdCategorias', 'INTEGER', 'categorias', 'id', true, null, null);
        $this->addColumn('endereco', 'Endereco', 'VARCHAR', true, null, null);
        $this->addColumn('datainclusao', 'Datainclusao', 'DATE', false, null, null);
        $this->addForeignKey('id_cliente', 'IdCliente', 'INTEGER', 'clientes', 'id', true, null, null);
        $this->addColumn('nomedocumento', 'Nomedocumento', 'VARCHAR', false, null, null);
        $this->addColumn('descricao', 'Descricao', 'VARCHAR', false, null, null);
    } // initialize()
    ...
    {
        $this->addRelation('Categorias', '\\Categorias', RelationMap::MANY_TO_ONE, array('id_categorias' => 'id', ), null, null);
        $this->addRelation('Clientes', '\\Clientes', RelationMap::MANY_TO_ONE, array('id_cliente' => 'id', ), null, null);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(DocumentosTableMap::COL_ID_CATEGORIAS);
            $criteria->addSelectColumn(DocumentosTableMap::COL_ENDERECO);
            $criteria->addSelectColumn(DocumentosTableMap::COL_DATAINCLUSAO);
            $criteria->addSelectColumn(DocumentosTableMap::COL_ID_CLIENTE);
            ...
            $criteria->addSelectColumn($alias . '.id_categorias');
