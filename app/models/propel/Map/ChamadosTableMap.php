...
class ChamadosTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('UpdatedAt', 'CreatedAt', 'Data', 'Mensagem', 'Status', 'Titulo', 'Categoria', 'Usuario', 'Id', ),
        self::TYPE_CAMELNAME     => array('updatedAt', 'createdAt', 'data', 'mensagem', 'status', 'titulo', 'categoria', 'usuario', 'id', ),
        self::TYPE_COLNAME       => array(ChamadosTableMap::COL_UPDATED_AT, ChamadosTableMap::COL_CREATED_AT, ChamadosTableMap::COL_DATA, ChamadosTableMap::COL_MENSAGEM, ChamadosTableMap::COL_STATUS, ChamadosTableMap::COL_TITULO, ChamadosTableMap::COL_CATEGORIA, ChamadosTableMap::COL_USUARIO, ChamadosTableMap::COL_ID, ),
        self::TYPE_FIELDNAME     => array('updated_at', 'created_at', 'data', 'mensagem', 'status', 'titulo', 'categoria', 'usuario', 'id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('UpdatedAt' => 0, 'CreatedAt' => 1, 'Data' => 2, 'Mensagem' => 3, 'Status' => 4, 'Titulo' => 5, 'Categoria' => 6, 'Usuario' => 7, 'Id' => 8, ),
        self::TYPE_CAMELNAME     => array('updatedAt' => 0, 'createdAt' => 1, 'data' => 2, 'mensagem' => 3, 'status' => 4, 'titulo' => 5, 'categoria' => 6, 'usuario' => 7, 'id' => 8, ),
        self::TYPE_COLNAME       => array(ChamadosTableMap::COL_UPDATED_AT => 0, ChamadosTableMap::COL_CREATED_AT => 1, ChamadosTableMap::COL_DATA => 2, ChamadosTableMap::COL_MENSAGEM => 3, ChamadosTableMap::COL_STATUS => 4, ChamadosTableMap::COL_TITULO => 5, ChamadosTableMap::COL_CATEGORIA => 6, ChamadosTableMap::COL_USUARIO => 7, ChamadosTableMap::COL_ID => 8, ),
        self::TYPE_FIELDNAME     => array('updated_at' => 0, 'created_at' => 1, 'data' => 2, 'mensagem' => 3, 'status' => 4, 'titulo' => 5, 'categoria' => 6, 'usuario' => 7, 'id' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
