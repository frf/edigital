...
/**
 * Base class that represents a row from the 'chamados' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Chamados implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ChamadosTableMap';
    ...
    /**
     * Initializes internal state of Base\Chamados object.
     */
    ...
    /**
     * Compares this with another <code>Chamados</code> instance.  If
     * <code>obj</code> is an instance of <code>Chamados</code>, delegates to
     * <code>equals(Chamados)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Chamados The current object, for fluid interface
     */
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($dt !== $this->created_at) {
                $this->created_at = $dt;
                $this->modifiedColumns[ChamadosTableMap::COL_CREATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ChamadosTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->updated_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ChamadosTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ChamadosTableMap::translateFieldName('Data', TableMap::TYPE_PHPNAME, $indexType)];
            $this->data = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ChamadosTableMap::translateFieldName('Mensagem', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ChamadosTableMap::translateFieldName('Titulo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->titulo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ChamadosTableMap::translateFieldName('Categoria', TableMap::TYPE_PHPNAME, $indexType)];
            $this->categoria = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ChamadosTableMap::translateFieldName('Usuario', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 9; // 9 = ChamadosTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Chamados'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildChamadosQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Chamados::setDeleted()
     * @see Chamados::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildChamadosQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ChamadosTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('chamados_id_seq')");
        ...
        $sql = sprintf(
            'INSERT INTO chamados (%s) VALUES (%s)',
    ...
    {
        $pos = ChamadosTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setMensagem($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setStatus($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setTitulo($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setCategoria($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setUsuario($arr[$keys[7]]);
        }
    ...
    {
        $criteria = ChildChamadosQuery::create();
        $criteria->add(ChamadosTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Chamados (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Chamados Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ChamadosTableMap::DEFAULT_STRING_FORMAT);
    }
