 ...
 * @method     ChildUsuarios requireOneByIdcliente(int $idcliente) Return the first ChildUsuarios filtered by the idcliente column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUsuarios requireOneByIsdelete(boolean $isdelete) Return the first ChildUsuarios filtered by the isdelete column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUsuarios requireOneByLang(string $lang) Return the first ChildUsuarios filtered by the lang column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
...
abstract class UsuariosQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, email, senha, nome, tipo, remember_token, created_at, updated_at, idcliente, isdelete, lang FROM usuarios WHERE id = :p0';
        try {
