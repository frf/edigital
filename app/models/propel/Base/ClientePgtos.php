...
*/
abstract class ClientePgtos implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ClientePgtosTableMap';
    ...
    /**
     * The value for the idproduto field.
     * @var        int
     */
    protected $idproduto;
    ...
    /**
     * The value for the ispaid field.
    ...
    /**
     * Initializes internal state of Base\ClientePgtos object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ClientePgtos</code> instance.  If
     * <code>obj</code> is an instance of <code>ClientePgtos</code>, delegates to
     * <code>equals(ClientePgtos)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ClientePgtos The current object, for fluid interface
     */
    ...
    /**
     * Get the [idproduto] column value.
     *
     * @return int
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ClientePgtosTableMap::COL_ID] = true;
        }
    ...
    public function setValor($v)
    {
        ...
        if ($this->valor !== $v) {
            $this->valor = $v;
            $this->modifiedColumns[ClientePgtosTableMap::COL_VALOR] = true;
        }
    ...
    /**
     * Set the value of [idproduto] column.
     *
     * @param  int $v new value
     * @return $this|\ClientePgtos The current object (for fluent API support)
     */
    public function setIdproduto($v)
    {
        ...
        if ($this->idproduto !== $v) {
            $this->idproduto = $v;
            $this->modifiedColumns[ClientePgtosTableMap::COL_IDPRODUTO] = true;
        }

        if ($this->aProdutos !== null && $this->aProdutos->getId() !== $v) {
            $this->aProdutos = null;
        }
    ...
    public function setIdcliente($v)
    {
        ...
        if ($this->idcliente !== $v) {
            $this->idcliente = $v;
            $this->modifiedColumns[ClientePgtosTableMap::COL_IDCLIENTE] = true;
        }
    ...
    public function setDescricao($v)
    {
        ...
        if ($this->descricao !== $v) {
            $this->descricao = $v;
            $this->modifiedColumns[ClientePgtosTableMap::COL_DESCRICAO] = true;
        }
    ...
    /**
     * Sets the value of the [ispaid] column.
    ...
    public function setIspaid($v)
    {
        ...
        if ($this->ispaid !== $v) {
            $this->ispaid = $v;
            $this->modifiedColumns[ClientePgtosTableMap::COL_ISPAID] = true;
        }
    ...
    public function setNota($v)
    {
        ...
        if ($this->nota !== $v) {
            $this->nota = $v;
            $this->modifiedColumns[ClientePgtosTableMap::COL_NOTA] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ClientePgtosTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ClientePgtosTableMap::translateFieldName('Valor', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ClientePgtosTableMap::translateFieldName('Idcliente', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ClientePgtosTableMap::translateFieldName('Descricao', TableMap::TYPE_PHPNAME, $indexType)];
            $this->descricao = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ClientePgtosTableMap::translateFieldName('Ispaid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ispaid = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ClientePgtosTableMap::translateFieldName('Nota', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nota = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ClientePgtosTableMap::translateFieldName('Dtpagamento', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    {
        if ($this->aProdutos !== null && $this->idproduto !== $this->aProdutos->getId()) {
            $this->aProdutos = null;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildClientePgtosQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ClientePgtos::setDeleted()
     * @see ClientePgtos::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildClientePgtosQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ClientePgtosTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aProdutos !== null) {
                ...
                $this->setProdutos($this->aProdutos);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('cliente_pgtos_id_seq')");
        ...
        if ($this->isColumnModified(ClientePgtosTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ClientePgtosTableMap::COL_VALOR)) {
            $modifiedColumns[':p' . $index++]  = 'valor';
        }
        if ($this->isColumnModified(ClientePgtosTableMap::COL_IDPRODUTO)) {
            $modifiedColumns[':p' . $index++]  = 'idproduto';
        }
        ...
        if ($this->isColumnModified(ClientePgtosTableMap::COL_DESCRICAO)) {
            $modifiedColumns[':p' . $index++]  = 'descricao';
        }
        if ($this->isColumnModified(ClientePgtosTableMap::COL_ISPAID)) {
            $modifiedColumns[':p' . $index++]  = 'ispaid';
        }
        ...
        $sql = sprintf(
            'INSERT INTO cliente_pgtos (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'valor':
                        ...
                        break;
                    case 'idproduto':
                        $stmt->bindValue($identifier, $this->idproduto, PDO::PARAM_INT);
                        break;
                    case 'idcliente':
                    ...
                    case 'descricao':
                        ...
                        break;
                    case 'ispaid':
                        $stmt->bindValue($identifier, $this->ispaid, PDO::PARAM_BOOL);
                        break;
                    case 'nota':
    ...
    {
        $pos = ClientePgtosTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ClientePgtos'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aProdutos) {
                ...
                $result[$key] = $this->aProdutos->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setIspaid($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setNota($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setDtpagamento($arr[$keys[8]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClientePgtosTableMap::COL_ID)) {
            $criteria->add(ClientePgtosTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ClientePgtosTableMap::COL_VALOR)) {
            $criteria->add(ClientePgtosTableMap::COL_VALOR, $this->valor);
        }
        if ($this->isColumnModified(ClientePgtosTableMap::COL_IDPRODUTO)) {
            $criteria->add(ClientePgtosTableMap::COL_IDPRODUTO, $this->idproduto);
        }
        if ($this->isColumnModified(ClientePgtosTableMap::COL_IDCLIENTE)) {
        ...
        if ($this->isColumnModified(ClientePgtosTableMap::COL_DESCRICAO)) {
            $criteria->add(ClientePgtosTableMap::COL_DESCRICAO, $this->descricao);
        }
        if ($this->isColumnModified(ClientePgtosTableMap::COL_ISPAID)) {
            $criteria->add(ClientePgtosTableMap::COL_ISPAID, $this->ispaid);
        }
        if ($this->isColumnModified(ClientePgtosTableMap::COL_NOTA)) {
    ...
    {
        $criteria = ChildClientePgtosQuery::create();
        $criteria->add(ClientePgtosTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ClientePgtos (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ClientePgtos Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCliente(ConnectionInterface $con = null)
    {
        if ($this->aCliente === null && ($this->idcliente !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCliente->addClientePgtoss($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function setProdutos(ChildProdutos $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildProdutos object, it will not be re-added.
        if ($v !== null) {
            $v->addClientePgtos($this);
        }
    ...
    /**
     * Get the associated ChildProdutos object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildProdutos The associated ChildProdutos object.
     * @throws PropelException
     */
    public function getProdutos(ConnectionInterface $con = null)
    {
        if ($this->aProdutos === null && ($this->idproduto !== null)) {
            $this->aProdutos = ChildProdutosQuery::create()->findPk($this->idproduto, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProdutos->addClientePgtoss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ClientePgtosTableMap::DEFAULT_STRING_FORMAT);
    }
