...
/**
 * Base class that represents a row from the 'status_chamados' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class StatusChamados implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\StatusChamadosTableMap';
    ...
    /**
     * Initializes internal state of Base\StatusChamados object.
     */
    ...
    /**
     * Compares this with another <code>StatusChamados</code> instance.  If
     * <code>obj</code> is an instance of <code>StatusChamados</code>, delegates to
     * <code>equals(StatusChamados)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|StatusChamados The current object, for fluid interface
     */
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($dt !== $this->created_at) {
                $this->created_at = $dt;
                $this->modifiedColumns[StatusChamadosTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 4; // 4 = StatusChamadosTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\StatusChamados'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildStatusChamadosQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see StatusChamados::setDeleted()
     * @see StatusChamados::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildStatusChamadosQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StatusChamadosTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('status_chamados_id_seq')");
        ...
        $sql = sprintf(
            'INSERT INTO status_chamados (%s) VALUES (%s)',
    ...
    {
        $pos = StatusChamadosTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['StatusChamados'][$this->hashCode()])) {
            return '*RECURSION*';
        }
    ...
    {
        $criteria = ChildStatusChamadosQuery::create();
        $criteria->add(StatusChamadosTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \StatusChamados (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \StatusChamados Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(StatusChamadosTableMap::DEFAULT_STRING_FORMAT);
    }
