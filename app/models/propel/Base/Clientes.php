...
*/
abstract class Clientes implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ClientesTableMap';
    ...
    /**
     * Initializes internal state of Base\Clientes object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Clientes</code> instance.  If
     * <code>obj</code> is an instance of <code>Clientes</code>, delegates to
     * <code>equals(Clientes)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Clientes The current object, for fluid interface
     */
     ...
     * @return $this|\Clientes The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ClientesTableMap::COL_ID] = true;
        }
    ...
    public function setNome($v)
    {
        ...
        if ($this->nome !== $v) {
            $this->nome = $v;
            $this->modifiedColumns[ClientesTableMap::COL_NOME] = true;
        }
    ...
    public function setLogin($v)
    {
        ...
        if ($this->login !== $v) {
            $this->login = $v;
            $this->modifiedColumns[ClientesTableMap::COL_LOGIN] = true;
        }
    ...
    public function setSenha($v)
    {
        ...
        if ($this->senha !== $v) {
            $this->senha = $v;
            $this->modifiedColumns[ClientesTableMap::COL_SENHA] = true;
        }
    ...
    public function setAtivo($v)
    {
        ...
        if ($this->ativo !== $v) {
            $this->ativo = $v;
            $this->modifiedColumns[ClientesTableMap::COL_ATIVO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ClientesTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ClientesTableMap::translateFieldName('Nome', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nome = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ClientesTableMap::translateFieldName('Login', TableMap::TYPE_PHPNAME, $indexType)];
            $this->login = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ClientesTableMap::translateFieldName('Senha', TableMap::TYPE_PHPNAME, $indexType)];
            $this->senha = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ClientesTableMap::translateFieldName('Ativo', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = ClientesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Clientes'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildClientesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Clientes::setDeleted()
     * @see Clientes::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildClientesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ClientesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->enderecosScheduledForDeletion !== null) {
                if (!$this->enderecosScheduledForDeletion->isEmpty()) {
                    foreach ($this->enderecosScheduledForDeletion as $endereco) {
                        // need to save related object because we set the relation to null
                        $endereco->save($con);
                    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ClientesTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ClientesTableMap::COL_ID . ')');
        }
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('clientes_id_seq')");
        ...
        if ($this->isColumnModified(ClientesTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ClientesTableMap::COL_NOME)) {
            $modifiedColumns[':p' . $index++]  = 'nome';
        }
        if ($this->isColumnModified(ClientesTableMap::COL_LOGIN)) {
            $modifiedColumns[':p' . $index++]  = 'login';
        }
        if ($this->isColumnModified(ClientesTableMap::COL_SENHA)) {
            $modifiedColumns[':p' . $index++]  = 'senha';
        }
        if ($this->isColumnModified(ClientesTableMap::COL_ATIVO)) {
    ...
    {
        $pos = ClientesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Clientes'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Clientes'][$this->hashCode()] = true;
        $keys = ClientesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNome(),
    ...
    {
        $criteria = new Criteria(ClientesTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ClientesTableMap::COL_ID)) {
            $criteria->add(ClientesTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ClientesTableMap::COL_NOME)) {
            $criteria->add(ClientesTableMap::COL_NOME, $this->nome);
        }
        if ($this->isColumnModified(ClientesTableMap::COL_LOGIN)) {
            $criteria->add(ClientesTableMap::COL_LOGIN, $this->login);
        }
        if ($this->isColumnModified(ClientesTableMap::COL_SENHA)) {
            $criteria->add(ClientesTableMap::COL_SENHA, $this->senha);
        }
        if ($this->isColumnModified(ClientesTableMap::COL_ATIVO)) {
            $criteria->add(ClientesTableMap::COL_ATIVO, $this->ativo);
        }
    ...
    {
        $criteria = ChildClientesQuery::create();
        $criteria->add(ClientesTableMap::COL_ID, $this->id);
     ...
     * If this ChildClientes is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildClientes The current object (for fluent API support)
     */
    public function setDocumentoss(Collection $documentoss, ConnectionInterface $con = null)
    {
        ...
        foreach ($documentossToDelete as $documentosRemoved) {
            $documentosRemoved->setClientes(null);
        }
    ...
    public function initEnderecos($overrideExisting = true)
    {
        ...
        $this->collEnderecos = new ObjectCollection();
    ...
    public function setEnderecos(Collection $enderecos, ConnectionInterface $con = null)
    {
        ...
        foreach ($enderecosToDelete as $enderecoRemoved) {
            $enderecoRemoved->setClientes(null);
        }
    ...
    public function removeEndereco(ChildEndereco $endereco)
    {
        if ($this->getEnderecos()->contains($endereco)) {
            ...
            $this->enderecosScheduledForDeletion[]= $endereco;
    ...
    {
        return (string) $this->exportTo(ClientesTableMap::DEFAULT_STRING_FORMAT);
    }
